...
local ex_home = "$HOME/문서/example"
local sh = require("luash/sh")
local DIRECTORY = 0
local FILE = 1
...
--[
while true do
	layout.display_menu(level_item[menu_level].menu, level_item[menu_level].prompt, level_item[menu_level].menu_keys)
